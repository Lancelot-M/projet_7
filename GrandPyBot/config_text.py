"""File whith long text to insert."""
...
"m","ma","maint","maintenant","mais","malgre","malgré","maximale","me",\
"meme","memes","merci","mes","mien","mienne","miennes","miens","mille",\
"mince","minimale","moi","moi-meme","moi-même","moindres","moins","mon",\
...
"notre","nous","nous-mêmes","nouveau","nul","néanmoins","nôtre","nôtres","o",\
"oh","ohé","ollé","olé","on","ont","onze","onzième","ore","ou","ouf","ouias",\
"oust","ouste","outre","ouvert","ouverte","ouverts","o|","où","p","paf",\
"pan","par","parce","parfois","parle","parlent","parler","parmi","parseme",\
"partant","particulier","particulière","particulièrement","pas","passé",\
"pendant","pense","permet","personne","peu","peut","peuvent","peux",\
"pff","pfft","pfut","pif","pire","plein","plouf","plus","plusieurs",\
"plutôt","possessif","possessifs","possible","possibles","pouah","pour",\
"pourquoi","pourrais","pourrait","pouvait","prealable","precisement",\
"premier","première","premièrement","pres","probable","probante",\
"procedant","proche","près","psitt","pu","puis","puisque","pur","pure",\
"q","qu","quand","quant","quant-à-soi","quanta","quarante","quatorze",\
...
"tu","té","u","un","une","unes","uniformement","unique","uniques",\
"uns","v","va","vais","vas","vers","via","vif","vifs","vingt","vivat",\
"vive","vives","vlan","voici","voilà","vont","vos","votre","vous",\
"vous-mêmes","vu","vé","vôtre","vôtres","w","x","y","z","zut","à","â","ça",\
